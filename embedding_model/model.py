...
class SeparationModel():
    ...
    def add_loss_op(self, target):
        ...
        tf.summary.histogram('soft masked output', tf.abs(self.soft_masked_output))
        tf.summary.histogram('abs target',real_target)
        tf.summary.histogram('masked loss dist', masked_loss)
